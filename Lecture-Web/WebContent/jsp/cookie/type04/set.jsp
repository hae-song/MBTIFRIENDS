...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    Cookie c2 = new Cookie("type02", URLEncoder.encode("/Lecture-Web/jsp/cookie/type02encoding 루트설정", "utf-8"));
    c2.setPath("/Lecture-Web/jsp/cookie/type02");
    
    Cookie c3 = new Cookie("type03", URLEncoder.encode("/Lecture-Web/jsp/cookie/type03time 루트설정", "utf-8"));
