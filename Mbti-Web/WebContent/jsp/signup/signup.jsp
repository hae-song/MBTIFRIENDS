...
<body bgcolor="#FFFFCC" onLoad="regFrm.id.focus()">
   ...
   <div align="center">
   <br /><br />
   <form name="regFrm" method="post" action="/index2.jsp">
                  ...
                  <table align="1r" border="0" cellpadding="2" align="center"
                     ...
                     <td>
                      <select name="likembti" size=1>
                        ...
                        <td>
                        <select name="dislikembti" size=1>
                        <option value="">뭐예요?</option>
                        <option value="ESTJ">ESTJ</option> 
                        <option value="ESTP">ESTP</option> 
                        <option value="ESFP">ESFP</option> 
